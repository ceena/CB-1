...
square_left.text_el = paper.text((60+250), (50+50), "Dog").attr({'font-size':'20px','text-anchor': 'center'}).toBack();
...
square2_left.text_el = paper.text((60+250), (175+50), "Cat").attr({'font-size':'20px','text-anchor': 'center'}).toBack();
...
square3_left.text_el = paper.text((60+250), (300+50), "Lion").attr({'font-size':'20px','text-anchor': 'center'}).toBack();
...
square.text_el = paper.text((600+250), (50+50), "I am the KING...").attr({'font-size':'20px','text-anchor': 'start'}).toBack();
...
square2.text_el = paper.text((600+250), (175+50), "I am very LOYAL...").attr({'font-size':'20px','text-anchor': 'start'}).toBack();
...
square3.text_el = paper.text((600+250), (300+50), "I am very SMART...").attr({'font-size':'20px','text-anchor': 'start'}).toBack();
